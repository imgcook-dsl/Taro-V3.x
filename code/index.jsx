    ...
    return (
        <View className="box">
          <View className="hd">
            <Image
                className="layer"
                src={'https://ai-sample.oss-cn-hangzhou.aliyuncs.com/test/91d46030470311eabd7ec1fa8ec28140.png'}
            />
          ...
          <View className="row1">
            <Image
                className="itemLong"
                src={'https://ai-sample.oss-cn-hangzhou.aliyuncs.com/test/94877240470311ea857481b7fe145c48.png'}
            />
          ...
          <View className="row2">
            <Image
                ...
                src={'https://ai-sample.oss-cn-hangzhou.aliyuncs.com/test/9a971cd0470311eab5896d6b6f989c88.png'}
            />
          ...
          <View className="row3">
            <Image
                ...
                src={'https://ai-sample.oss-cn-hangzhou.aliyuncs.com/test/967622e0470311eaa7ebf7bd350c0c46.png'}
            />
          ...
          <View className="ft">
            <Image
                ...
                src={'https://ai-sample.oss-cn-hangzhou.aliyuncs.com/test/98582950470311eaa40befe213bb33d1.png'}
            />
                ...
                <View className="block_19">
                  <View className="block_18">
                    <Image
                        ...
                        src={'https://ai-sample.oss-cn-hangzhou.aliyuncs.com/test/9ae8bf40470311ea8463a1554a8aa17b.png'}
                    />
                  </View>
                </View>
